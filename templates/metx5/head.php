...
echo <<<EOT
-->
			<li style="background:url({$val[img_path]}) no-repeat center center; height:{$met_flasharray[$classnow][y]}px; background-size:100% :{$met_flasharray[$classnow][y]}px">{$val[html]}</li>
<!--
EOT;
}
echo <<<EOT
